        ...
        <div className="mx-auto max-w-[1600px] px-4 lg:px-6">
          ...
          <div className="grid gap-5 lg:grid-cols-[280px_minmax(0,1fr)_300px]">
            ...
            <div className="min-w-0 space-y-5">
              <section id="profile" className="rounded-md border border-autox-border bg-gradient-to-br from-autox-panel to-black p-5 lg:p-6">
                <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                  <div className="flex min-w-0 items-center gap-4">
                    ...
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="rounded-sm bg-autox-red/15 px-2 py-1 text-[10px] font-bold uppercase text-autox-red">Customer</span>
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-px overflow-hidden rounded-md border border-autox-border bg-autox-border sm:grid-cols-4 xl:min-w-[430px]">
                    {[
              ...
              <section id="orders" className="rounded-md border border-autox-border bg-autox-panel p-4 lg:p-5">
                <div className="mb-4 flex items-center justify-between gap-4">
                  <h2 className="text-lg font-extrabold text-white">My Orders</h2>
                  <Link href="/account/orders" className="flex items-center gap-2 rounded-sm border border-autox-red px-3 py-2 text-[11px] font-bold uppercase text-white transition-colors hover:bg-autox-red">View All Orders <ArrowRight size={13} /></Link>
                </div>

                {!latestOrder ? (
                  <div className="rounded-md border border-dashed border-autox-border bg-black/30 p-8 text-center">
                    ...
                    <Link href="/products" className="mt-4 inline-flex h-9 items-center rounded-sm bg-autox-red px-4 text-xs font-bold uppercase text-white">Shop Parts</Link>
                  </div>
                ) : (
                  <div className="rounded-md border border-autox-border bg-black/25 p-4 lg:p-5">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                      <div className="h-24 w-24 shrink-0 overflow-hidden rounded-md border border-autox-border bg-autox-panel3">
                      ...
                      <div className="sm:text-right">
                        <span className={`inline-block rounded-sm px-2.5 py-1 text-[10px] font-bold uppercase ${latestStatus?.className}`}>{latestStatus?.label}</span>
                        <p className="mt-3 text-lg font-extrabold text-white">{formatPrice(latestOrder.total)}</p>
                        <Link href={`/orders/track?order=${encodeURIComponent(latestOrder.orderNumber)}`} className="mt-3 inline-flex items-center gap-2 rounded-sm border border-autox-red px-3 py-2 text-[11px] font-bold uppercase text-white hover:bg-autox-red">View Order Details <ArrowRight size={13} /></Link>
                      </div>
                    </div>
              ...
              <section id="payment" className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-md border border-autox-border bg-autox-panel p-4"><h3 className="flex items-center gap-2 text-sm font-bold text-white"><WalletCards size={17} className="text-autox-red" /> Payment Methods</h3><p className="mt-2 text-xs leading-5 text-autox-gray">Available payment methods are selected securely during checkout.</p></div>
                <div className="rounded-md border border-autox-border bg-autox-panel p-4"><h3 className="flex items-center gap-2 text-sm font-bold text-white"><Headphones size={17} className="text-autox-red" /> Customer Support</h3><p className="mt-2 text-xs leading-5 text-autox-gray">Need help with a product or order? Our support page is always available.</p></div>
              </section>
            </div>

            <aside className="space-y-5">
              <section id="security" className="rounded-md border border-autox-border bg-autox-panel p-5">
              ...
              <section className="rounded-md border border-autox-border bg-gradient-to-br from-autox-red/10 to-autox-panel p-5">
                ...
                <Link href="/offers" className="mt-5 flex h-9 items-center justify-center rounded-sm border border-autox-red text-[11px] font-bold uppercase text-autox-red transition-colors hover:bg-autox-red hover:text-white">View Offers</Link>
              </section>
            </aside>
          </div>

          <section className="mt-5 grid overflow-hidden rounded-md border border-autox-red/20 bg-gradient-to-r from-autox-red/10 via-autox-panel to-autox-red/10 sm:grid-cols-2 lg:grid-cols-5">
            {[
