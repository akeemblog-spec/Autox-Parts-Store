...
const input = "w-full bg-autox-panel3 border border-autox-border rounded-xl px-3 text-sm text-white outline-none focus:border-autox-red";
...
export function ContactForm() {
  ...
  return <form onSubmit={submit} className="space-y-4 rounded-2xl border border-autox-border bg-autox-panel p-6">
