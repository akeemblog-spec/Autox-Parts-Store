...
export function AdminHeader({name="Admin",role="admin",onMenuOpen}:{name?:string;role?:"admin"|"super_admin";onMenuOpen?:()=>void}){
  ...
  return <header className="sticky top-0 z-40 flex h-14 items-center border-b border-autox-border bg-black/95 px-3 backdrop-blur sm:h-16 sm:px-4 lg:px-6">
