  ...
  return <section className="relative z-20 mx-auto max-w-[1600px] px-4 pb-10 pt-5 lg:px-6 lg:pt-7">
    <div className="overflow-hidden rounded-2xl border border-white/10 bg-[#0c0c0e]/95 shadow-[0_24px_70px_rgba(0,0,0,.35)] backdrop-blur-xl">
      <div className="p-4 sm:p-5 lg:p-6">
        <div className="flex items-start gap-3"><span className="autox-neon-icon mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center"><SlidersHorizontal size={18} className="autox-neon-mark"/></span><div><h2 className="text-sm font-black uppercase tracking-[.04em] text-white sm:text-base">Find Parts For <span className="text-autox-red">Your Vehicle</span></h2><p className="mt-1 text-xs leading-5 text-zinc-500">Choose what you know. Brand is required; model and year refine the match.</p></div></div>
