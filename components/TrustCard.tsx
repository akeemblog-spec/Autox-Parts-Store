...
export function TrustCard({ feature }: { feature: TrustFeature }) {
  ...
  return (
    <div className="flex flex-col items-center text-center bg-autox-panel border border-autox-border rounded-2xl p-5 hover:border-autox-red/50 transition-colors">
